...
public class CountExercise {
	...
	int []result1 = new int[500];		//三个数组分别存储加法算式、减法算式、加减法混合算式的结果
	int []result2 = new int[500];
	int []result3 = new int[500];
	
	
	//三个数组分别存储加法算式、减法算式、加减法混合算式的算式
	public static LinkedHashSet<String> set1 =new LinkedHashSet<String>();		
	public static LinkedHashSet<String> set2 =new LinkedHashSet<String>();
	public static LinkedHashSet<String> set3 =new LinkedHashSet<String>();
